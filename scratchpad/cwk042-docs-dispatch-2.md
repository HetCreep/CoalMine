...
Write `scratchpad/cwk042-bodies-2.json`: an array of `{ "tag": "vX.Y.Z", "body": "...",
...
---
## ROUND 2 — amendment to the above
Round 1 is DONE and already banked (`v3.17.3 v3.17.2 v3.16.0 v3.14.0`) — do NOT redo them.
Your round-1 return said you stopped at my stated 3-4 estimate with headroom COMFORTABLE.
That estimate was my guess, not a cap. **Work the remaining 28 in the order listed until
your own quality or headroom genuinely says stop — then stop and name the remainder.**
`ห้ามฝืนคุณภาพ` still binds: I would rather have 6 right than 15 rushed. You judge it.

Remaining 28, newest first:
v3.13.0 v3.12.3 v3.12.2 v3.12.1 v3.12.0 v3.11.4 v3.11.3 v3.11.2 v3.11.1 v3.11.0
v3.10.0 v3.9.0 v3.8.5 v3.8.3 v3.8.0 v3.7.12 v3.7.11 v3.7.10 v3.7.8 v3.7.7 v3.7.6
v3.7.4 v3.7.3 v3.5.1 v3.5.0 v3.4.0 v3.3.0 v3.2.1

Round-1 judgment I RATIFY, apply it again: a closing methodological/process sentence in an
entry (a lesson about how a claim was verified) is not shipped-behavior material and stays
out of the body — that is not dropping a user-facing caveat. A caveat about what the
release DOES still goes in, always.
