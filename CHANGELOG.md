...
- All 4 auto-trigger templates upgraded from rotcanary-only to the full 9-canary keyword table + 6 proactive offer-conditions + session-end rule.
- `platform-configs/hooks/antigravity-hooks.json` and `hooks/settings.snippet.json` (Claude Code non-plugin wiring).
