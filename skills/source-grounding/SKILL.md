...
## Language
Write the report, all prose, **and every selectable choice / option label you pop** in **the user's language** — match whatever language they are conversing in (Thai -> Thai, etc.). Keep code, file paths, identifiers, commands, error text, and technical terms verbatim — never translate those.
